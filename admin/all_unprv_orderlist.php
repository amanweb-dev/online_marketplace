                                ...
                                <div class="table-responsive" style="margin-bottom: 200px">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                                 ...
                                                 <?php 
                                                        $query = "select * from orders where ordr_status = 0 ";
                                             ...
                                             ?>
                                                ...
                                                <tr class="success">
                                                    ...
                                                    <td><a  href="sngl_orderlist.php?ordrid=<?php echo $ordr_id; ?>"><button class="btn btn-danger">View</button></a></td>

                                                    <td><a onclick="return confirm('Are you sure to request to Seller?')" href="?req_ordr_id=<?php echo $ordr_id; ?>"><button type="submit" class="btn btn-danger">Request</button></a></td>
