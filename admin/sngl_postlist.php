                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i>sngl_unprv_postlist
                            </li>
                        </ol>
                                        ...
                                        if ($update) {
                                          echo "<p style='color:green;text-align:center;font-size:20px;'>Post Approved successfully</p>";
                                            ...
                                            echo "<p style='color:red;text-align:center;'>opps!! Post is not Approved</p>";
                                                 ...
                                                 <?php 
                                                        if (isset($_GET['un_post_list'])) {

                                                         $un_post_list_id = $_GET['un_post_list'];
                                                        $query = "select * from post where post_id = $un_post_list_id ";
